...
import com.nichtemna.takeandsavephoto.fragment.FolderDone;
import com.nichtemna.takeandsavephoto.fragment.FolderDone.MyPageChangeListener;
...
public class TugasSelesai extends FragmentActivity {
	...
	private void init() {
		...
		folderDone = new FolderDone();
		t.replace(R.id.center_frame, folderDone);
	...
	private void initListener() {
		...
		folderDone.setMyPageChangeListener(new MyPageChangeListener() {
			
			@Override
			public void onPageSelected(int position) {
				if(folderDone.isFirst()){
					mSlidingMenu.setCanSliding(true,false);
				}else if(folderDone.isEnd()){
