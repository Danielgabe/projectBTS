...
public class TugasSaya extends Fragment {
	Context context;
	Resources resource;
	 ...
	 public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {		 
		//super.onCreate(savedInstanceState);
		 ...
		 context = this.getActivity();
	        ...
	        mView = inflater.inflate(R.layout.tugassaya, null);			
...
//			showSearch = (Button) mView.findViewById(R.id.showSearch);
	...
	private void getDataNom() {
		...
		List<to_do> to_do_List = db.getAll_todo_list_0();
		...
		for (to_do dataNom : to_do_List) {
            ...
            province.setGravity(Gravity.CENTER | Gravity.CENTER);
